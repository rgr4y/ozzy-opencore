...
def generate_smbios_for_changeset(changeset_name, force=False):
    ...
    for changeset in changesets:
        try:
            ...
            if changeset_data and 'smbios' in changeset_data:
                ...
                info(f"- {changeset:<25} {'N/A':<12} No SMBIOS data")
...
Examples:
  ...
  python3.11 scripts/generate-serial.py --generate-only
    ...
    if generate_smbios_for_changeset(changeset_name, args.force):
        return 0
    else:
        return 1
